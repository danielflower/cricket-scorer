...
public final class MatchControl {
     ...
     * event, as events may generate child events. To undo the last added user event, call {@link #previousUserGeneratedEvent()}
     * instead.</p>
     * @return the parent of this control
     * @see #hasParent()
     * @see #previousUserGeneratedEvent()
     * @see #lastUserGeneratedEvent()
     ...
     * @see #previousUserGeneratedEvent()
     */
    public MatchControl lastUserGeneratedEvent() {
     ...
     * <p>This differs from {@link #lastUserGeneratedEvent()} in that that method may return
     * the current state of the match.</p>
     * @return The match with the last user generated event undone.
     * @see #lastUserGeneratedEvent()
     */
    public MatchControl previousUserGeneratedEvent() {
        return lastUserGeneratedEvent().parent().lastUserGeneratedEvent();
    }
}

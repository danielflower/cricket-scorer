...
public class England {
    public static final Player ALI = player("Moeen Ali").withPlayingRole(ALL_ROUNDER).withBattingHandedness(LeftHanded).build();
    public static final Player ANDERSON = player("James Anderson").withPlayingRole(BOWLER).withBattingHandedness(LeftHanded).build();
    ...
    public static final Player BROAD = player("Stuart Broad").withPlayingRole(BOWLER).withBattingHandedness(LeftHanded).build();
    public static final Player BROWN = player("Pat Brown").withPlayingRole(BOWLER).build();
    public static final Player BURNS = player("Rory Burns").withPlayingRole(BATTER).withBattingHandedness(LeftHanded).build();
    ...
    public static final Player SAM_CURRAN = player("Sam Curran").withPlayingRole(ALL_ROUNDER).withBattingHandedness(LeftHanded).withBowlingHandedness(LeftHanded).build();
    ...
    public static final Player LEACH = player("Jack Leach").withPlayingRole(BOWLER).withBattingHandedness(LeftHanded).withBowlingHandedness(LeftHanded).build();
    public static final Player MAHMOOD = player("Saqib Mahmood").withPlayingRole(BOWLER).build();
    public static final Player MALAN = player("Dawid Malan").withPlayingRole(BATTER).withBattingHandedness(LeftHanded).build();
    public static final Player MORGAN = player("Eoin Morgan").withPlayingRole(BATTER).withBattingHandedness(LeftHanded).build();
    ...
    public static final Player STOKES = player("Ben Stokes").withPlayingRole(ALL_ROUNDER).withBattingHandedness(LeftHanded).build();
